        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(@"                     __             _                                                    _       
                    ...
                    __)|_||_)(/_|  \_\/|_)(/_|_>(/_(_|_|| | |_\/ /--\_>_>|_> |_(_|| ||_ |_)(_)|_ 
                          |          /                        /             ");
            //greeting plays before program starts
            player.PlaySync();
            //Borders are placed to split information up
            ...
            Console.ForegroundColor = ConsoleColor.White;
            //ask and retrieve the name of the user
            ...
            Console.ForegroundColor = ConsoleColor.White;
            Thread.Sleep(100);
            //when nothing is entered, the program will continually ask untill it is entered
            if (name == null)
            {
            ...
            Console.BackgroundColor = ConsoleColor.DarkBlue;
            Console.ForegroundColor = ConsoleColor.White;
            //greeting with name, instructions and exit method
            ...
            Console.BackgroundColor = ConsoleColor.Green;
            Console.ForegroundColor = ConsoleColor.Gray;
            //the input is set to all caps to prevent case sensitivity.
            string question = Console.ReadLine().ToUpper();
            Console.BackgroundColor = ConsoleColor.DarkBlue;
            Console.ForegroundColor = ConsoleColor.White;
            //program will give output based on what the user wrote.
            //it'll first chack for anything Cybersecurity related before looking for other relations.
            do
            {
                Console.BackgroundColor = ConsoleColor.White;
                Console.ForegroundColor = ConsoleColor.Black;
                ...
                //if there is nothing that the program knows about, it will ask for reclarification.
                else
                {
                    Console.BackgroundColor = ConsoleColor.Red;
            ...
            //upon the user entering "goodbye", the program will bid farewell and end.
            Console.BackgroundColor = ConsoleColor.DarkBlue;
